...
function addLink(item, linkText, linkClass) {
    ...
    return templateHelper.linkto(item, linkText, linkClass);
}
...
Helpers.prototype.link = function link(input, linkText, linkClass) {
...
Helpers.prototype.resetHeadingLevel = function resetHeadingLevel() {
    this.currentHeadingLevel = 1;
