...
var Template = module.exports = function Template(templatePath, optionsFile) {
    ...
    this._l10n = new Polyglot({ locale: this.config.locale });
    ...
    this.loadResources(this.config.modulePaths);
};
 ...
 * @returns {this}
 */
Template.prototype.loadResources = function loadResources(modulePaths) {
    var Helpers = require(modulePaths.helpers);
    var locals = {};
    var self = this;
    // TODO: make this an instance for consistency
    var swigFilters = require(modulePaths.filters);
    var swigHelpers = new Helpers(this);
    // TODO: make this an instance for consistency
    var swigLoader = require(modulePaths.loader);
    // TODO: make this an instance for consistency
    var swigTags = require(modulePaths.tags);

    // load the string resources
    this._l10n.extend(loadJson(path.resolve(this.path, this.config.resourceFile)));
...
Template.prototype.translate = function translate(key, opts) {
    /*eslint camelcase: 0 */
    var options;
    var translation;
    ...
    translation = this._l10n.t(key, options);
