...
DocletHelper.prototype._trackAlphabetically = function(doclet) {
    var alphaCategory;
    var longname = name.stripNamespace(doclet.longname);
...
DocletHelper.prototype.getAlphabetized = function() {
    return this.alpha;
};
