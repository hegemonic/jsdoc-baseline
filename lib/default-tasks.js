...
module.exports = config => ({
    copyStaticFiles: new t.CopyFiles({
        ...
        // TODO: Make this class work more like `GenerateFiles`, and create a `CopyStaticFiles`
        // subclass, so we can make this a static object.
    ...
    generateTutorials: new t.GenerateTutorials({
        name: 'generateTutorials',
        dependsOn: ['setContext']
    }),
