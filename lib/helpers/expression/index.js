...
module.exports = function(template) {
    ...
    return {
        ...
        generatedBy: function() {
            var formatter = new Intl.DateTimeFormat(template.config.locale, {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
            });
        ...
        hasModifiers: function(doclet, isEnum) {
            return Boolean(typeof doclet.nullable === 'boolean' ||
        ...
        returnTypes: function(doclet) {
            ...
            source.forEach(function(returned) {
