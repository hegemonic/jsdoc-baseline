...
var SCOPE_PUNC = new RegExp('([' + escape(_SCOPE_PUNC_VALUES) + '])');
...
module.exports = function(template) {
    ...
    return {
        ...
        formatParams: function(params) {
            return formatParams(params, template);
        },
        ...
        see: function(see, longname) {
            ...
            if (LEADING_SCOPE_PUNC.test(see)) {
                ...
                combined = name.combineName(atoms);
            }
