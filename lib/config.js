...
Config.prototype.readJson = function(filepath) {
    var parsedObject;
...
Config.prototype.load = function(configPath, templatePath) {
    ...
    this._config = _.defaults(this.readJson(configPath) || {}, this.defaultConfig,
