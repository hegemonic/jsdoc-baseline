 ...
 */
FileFinder.prototype._findAllSync = function(filename, breakOnFirstMatch) {
    var found = [];
    var p;
    var resolved;
...
FileFinder.prototype._findSync = function(filename) {
    var found = this._findAllSync(filename, true);
 ...
 * @throws {Error} The specified file cannot be found.
 */
FileFinder.prototype.findAllFilesSync = function(filename) {
    var filepaths = this._findAllSync(filename);
