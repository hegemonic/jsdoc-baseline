...
export class Filters {
  ...
  describeType(parsedType, kwargs) {
    ...
    const catharsisOptions = getCatharsisOptions(this.#template, codeTag);
    let description;
   ...
   */
  parseType(type) {
    return parseType(this.#template, type);
  }
  ...
  returnTypes(doclet) {
    ...
    return parseType(this.#template, typeUnion(typeUnions));
  }
   ...
   */
  typeUnion(types) {
    return parseType(this.#template, typeUnion(types));
  }
