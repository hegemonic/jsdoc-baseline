/*
  Copyright 2019 the Baseline Authors.
...
describe('lib/db', () => {
  ...
  describe('db', () => {
    ...
    it('can sort the doclets on the requested properties', () => {
      ...
      const values = db({
        values: [sorting.e, sorting.d, sorting.c, sorting.b, sorting.a],
      })
        .sortOn(['longname', 'since'])
        .value();

      expect(values).toEqual([sorting.a, sorting.b, sorting.c, sorting.d, sorting.e]);
    });
