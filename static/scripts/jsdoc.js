...
`;var zr=class extends Event{constructor(){super("wa-reposition",{bubbles:!0,cancelable:!1,composed:!0})}};var Wr=R`
  :host {
    --arrow-color: black;
    --arrow-size: var(--wa-tooltip-arrow-size);
...
`,zt,H=class extends oe{constructor(){super(),Zr(this,zt,!1),this.initialReflectedProperties=new Map,this.didSSR=!!this.shadowRoot,this.customStates={set:(t,o)=>{if(this.internals?.states)try{o?this.internals.states.add(t):this.internals.states.delete(t)}catch(r){if(String(r).includes("must start with '--'"))console.error("Your browser implements an outdated version of CustomStateSet. Consider using a polyfill");else throw r}},has:t=>{if(!this.internals?.states)return!1;try{return this.internals.states.has(t)}catch{return!1}}};try{this.internals=this.attachInternals()}catch{console.error("Element internals are not supported in your browser. Consider using a polyfill")}this.customStates.set("wa-defined",!0);let e=this.constructor;for(let[t,o]of e.elementProperties)o.default==="inherit"&&o.initial!==void 0&&typeof t=="string"&&this.customStates.set(`initial-${t}-${o.initial}`,!0)}static get styles(){let e=Array.isArray(this.css)?this.css:this.css?[this.css]:[];return[Ki,...e]}connectedCallback(){super.connectedCallback(),this.shadowRoot?.prepend(document.createComment(` Web Awesome: https://webawesome.com/docs/components/${this.localName.replace("wa-","")} `))}attributeChangedCallback(e,t,o){Yr(this,zt)||(this.constructor.elementProperties.forEach((r,a)=>{r.reflect&&this[a]!=null&&this.initialReflectedProperties.set(a,this[a])}),Qr(this,zt,!0)),super.attributeChangedCallback(e,t,o)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,o)=>{e.has(o)&&this[o]==null&&(this[o]=t)})}firstUpdated(e){super.firstUpdated(e),this.didSSR&&this.shadowRoot?.querySelectorAll("slot").forEach(t=>{t.dispatchEvent(new Event("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))})}update(e){try{super.update(e)}catch(t){if(this.didSSR&&!this.hasUpdated){let o=new Event("lit-hydration-error",{bubbles:!0,composed:!0,cancelable:!1});o.error=t,this.dispatchEvent(o)}throw t}}relayNativeEvent(e,t){e.stopImmediatePropagation(),this.dispatchEvent(new e.constructor(e.type,{...e,...t}))}};zt=new WeakMap;f([c()],H.prototype,"dir",2);f([c()],H.prototype,"lang",2);f([c({type:Boolean,reflect:!0,attribute:"did-ssr"})],H.prototype,"didSSR",2);var ye=Math.min,X=Math.max,Ct=Math.round,St=Math.floor,ue=e=>({x:e,y:e}),Yi={left:"right",right:"left",bottom:"top",top:"bottom"},Zi={start:"end",end:"start"};function Nt(e,t,o){return X(e,ye(t,o))}function qe(e,t){return typeof e=="function"?e(t):e}function Se(e){return e.split("-")[0]}function Ue(e){return e.split("-")[1]}function Co(e){return e==="x"?"y":"x"}function Vt(e){return e==="y"?"height":"width"}var Qi=new Set(["top","bottom"]);function be(e){return Qi.has(Se(e))?"y":"x"}function jt(e){return Co(be(e))}function oa(e,t,o){o===void 0&&(o=!1);let r=Ue(e),a=jt(e),s=Vt(a),i=a==="x"?r===(o?"end":"start")?"right":"left":r==="start"?"bottom":"top";return t.reference[s]>t.floating[s]&&(i=wt(i)),[i,wt(i)]}function ra(e){let t=wt(e);return[Wt(e),t,Wt(t)]}function Wt(e){return e.replace(/start|end/g,t=>Zi[t])}var ea=["left","right"],ta=["right","left"],Ji=["top","bottom"],en=["bottom","top"];function tn(e,t,o){switch(e){case"top":case"bottom":return o?t?ta:ea:t?ea:ta;case"left":case"right":return t?Ji:en;default:return[]}}function aa(e,t,o,r){let a=Ue(e),s=tn(Se(e),o==="start",r);return a&&(s=s.map(i=>i+"-"+a),t&&(s=s.concat(s.map(Wt)))),s}function wt(e){return e.replace(/left|right|bottom|top/g,t=>Yi[t])}function on(e){return{top:0,right:0,bottom:0,left:0,...e}}function So(e){return typeof e!="number"?on(e):{top:e,right:e,bottom:e,left:e}}function He(e){let{x:t,y:o,width:r,height:a}=e;return{width:r,height:a,top:o,left:t,right:t+r,bottom:o+a,x:t,y:o}}function sa(e,t,o){let{reference:r,floating:a}=e,s=be(t),i=jt(t),n=Vt(i),l=Se(t),d=s==="y",p=r.x+r.width/2-a.width/2,u=r.y+r.height/2-a.height/2,h=r[n]/2-a[n]/2,m;switch(l){case"top":m={x:p,y:r.y-a.height};break;case"bottom":m={x:p,y:r.y+r.height};break;case"right":m={x:r.x+r.width,y:u};break;case"left":m={x:r.x-a.width,y:u};break;default:m={x:r.x,y:r.y}}switch(Ue(t)){case"start":m[i]-=h*(o&&d?-1:1);break;case"end":m[i]+=h*(o&&d?-1:1);break}return m}async function ia(e,t){var o;t===void 0&&(t={});let{x:r,y:a,platform:s,rects:i,elements:n,strategy:l}=e,{boundary:d="clippingAncestors",rootBoundary:p="viewport",elementContext:u="floating",altBoundary:h=!1,padding:m=0}=qe(t,e),x=So(m),v=n[h?u==="floating"?"reference":"floating":u],y=He(await s.getClippingRect({element:(o=await(s.isElement==null?void 0:s.isElement(v)))==null||o?v:v.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(n.floating)),boundary:d,rootBoundary:p,strategy:l})),b=u==="floating"?{x:r,y:a,width:i.floating.width,height:i.floating.height}:i.reference,E=await(s.getOffsetParent==null?void 0:s.getOffsetParent(n.floating)),C=await(s.isElement==null?void 0:s.isElement(E))?await(s.getScale==null?void 0:s.getScale(E))||{x:1,y:1}:{x:1,y:1},O=He(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:n,rect:b,offsetParent:E,strategy:l}):b);return{top:(y.top-O.top+x.top)/C.y,bottom:(O.bottom-y.bottom+x.bottom)/C.y,left:(y.left-O.left+x.left)/C.x,right:(O.right-y.right+x.right)/C.x}}var na=async(e,t,o)=>{let{placement:r="bottom",strategy:a="absolute",middleware:s=[],platform:i}=o,n=s.filter(Boolean),l=await(i.isRTL==null?void 0:i.isRTL(t)),d=await i.getElementRects({reference:e,floating:t,strategy:a}),{x:p,y:u}=sa(d,r,l),h=r,m={},x=0;for(let v=0;v<n.length;v++){var g;let{name:y,fn:b}=n[v],{x:E,y:C,data:O,reset:S}=await b({x:p,y:u,initialPlacement:r,placement:h,strategy:a,middlewareData:m,rects:d,platform:{...i,detectOverflow:(g=i.detectOverflow)!=null?g:ia},elements:{reference:e,floating:t}});p=E??p,u=C??u,m={...m,[y]:{...m[y],...O}},S&&x<=50&&(x++,typeof S=="object"&&(S.placement&&(h=S.placement),S.rects&&(d=S.rects===!0?await i.getElementRects({reference:e,floating:t,strategy:a}):S.rects),{x:p,y:u}=sa(d,h,l)),v=-1)}return{x:p,y:u,placement:h,strategy:a,middlewareData:m}},la=e=>({name:"arrow",options:e,async fn(t){let{x:o,y:r,placement:a,rects:s,platform:i,elements:n,middlewareData:l}=t,{element:d,padding:p=0}=qe(e,t)||{};if(d==null)return{};let u=So(p),h={x:o,y:r},m=jt(a),x=Vt(m),g=await i.getDimensions(d),v=m==="y",y=v?"top":"left",b=v?"bottom":"right",E=v?"clientHeight":"clientWidth",C=s.reference[x]+s.reference[m]-h[m]-s.floating[x],O=h[m]-s.reference[m],S=await(i.getOffsetParent==null?void 0:i.getOffsetParent(d)),$=S?S[E]:0;(!$||!await(i.isElement==null?void 0:i.isElement(S)))&&($=n.floating[E]||s.floating[x]);let j=C/2-O/2,J=$/2-g[x]/2-1,te=ye(u[y],J),Pe=ye(u[b],J),he=te,Te=$-g[x]-Pe,G=$/2-g[x]/2+j,$e=Nt(he,G,Te),ve=!l.arrow&&Ue(a)!=null&&G!==$e&&s.reference[x]/2-(G<he?te:Pe)-g[x]/2<0,le=ve?G<he?G-he:G-Te:0;return{[m]:h[m]+le,data:{[m]:$e,centerOffset:G-$e-le,...ve&&{alignmentOffset:le}},reset:ve}}});var fa=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var o,r;let{placement:a,middlewareData:s,rects:i,initialPlacement:n,platform:l,elements:d}=t,{mainAxis:p=!0,crossAxis:u=!0,fallbackPlacements:h,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:x="none",flipAlignment:g=!0,...v}=qe(e,t);if((o=s.arrow)!=null&&o.alignmentOffset)return{};let y=Se(a),b=be(n),E=Se(n)===n,C=await(l.isRTL==null?void 0:l.isRTL(d.floating)),O=h||(E||!g?[wt(n)]:ra(n)),S=x!=="none";!h&&S&&O.push(...aa(n,g,x,C));let $=[n,...O],j=await l.detectOverflow(t,v),J=[],te=((r=s.flip)==null?void 0:r.overflows)||[];if(p&&J.push(j[y]),u){let G=oa(a,i,C);J.push(j[G[0]],j[G[1]])}if(te=[...te,{placement:a,overflows:J}],!J.every(G=>G<=0)){var Pe,he;let G=(((Pe=s.flip)==null?void 0:Pe.index)||0)+1,$e=$[G];if($e&&(!(u==="alignment"?b!==be($e):!1)||te.every(fe=>be(fe.placement)===b?fe.overflows[0]>0:!0)))return{data:{index:G,overflows:te},reset:{placement:$e}};let ve=(he=te.filter(le=>le.overflows[0]<=0).sort((le,fe)=>le.overflows[1]-fe.overflows[1])[0])==null?void 0:he.placement;if(!ve)switch(m){case"bestFit":{var Te;let le=(Te=te.filter(fe=>{if(S){let Le=be(fe.placement);return Le===b||Le==="y"}return!0}).map(fe=>[fe.placement,fe.overflows.filter(Le=>Le>0).reduce((Le,Ci)=>Le+Ci,0)]).sort((fe,Le)=>fe[1]-Le[1])[0])==null?void 0:Te[0];le&&(ve=le);break}case"initialPlacement":ve=n;break}if(a!==ve)return{reset:{placement:ve}}}return{}}}};var rn=new Set(["left","top"]);async function an(e,t){let{placement:o,platform:r,elements:a}=e,s=await(r.isRTL==null?void 0:r.isRTL(a.floating)),i=Se(o),n=Ue(o),l=be(o)==="y",d=rn.has(i)?-1:1,p=s&&l?-1:1,u=qe(t,e),{mainAxis:h,crossAxis:m,alignmentAxis:x}=typeof u=="number"?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return n&&typeof x=="number"&&(m=n==="end"?x*-1:x),l?{x:m*p,y:h*d}:{x:h*d,y:m*p}}var da=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){var o,r;let{x:a,y:s,placement:i,middlewareData:n}=t,l=await an(t,e);return i===((o=n.offset)==null?void 0:o.placement)&&(r=n.arrow)!=null&&r.alignmentOffset?{}:{x:a+l.x,y:s+l.y,data:{...l,placement:i}}}}},ua=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){let{x:o,y:r,placement:a,platform:s}=t,{mainAxis:i=!0,crossAxis:n=!1,limiter:l={fn:y=>{let{x:b,y:E}=y;return{x:b,y:E}}},...d}=qe(e,t),p={x:o,y:r},u=await s.detectOverflow(t,d),h=be(Se(a)),m=Co(h),x=p[m],g=p[h];if(i){let y=m==="y"?"top":"left",b=m==="y"?"bottom":"right",E=x+u[y],C=x-u[b];x=Nt(E,x,C)}if(n){let y=h==="y"?"top":"left",b=h==="y"?"bottom":"right",E=g+u[y],C=g-u[b];g=Nt(E,g,C)}let v=l.fn({...t,[m]:x,[h]:g});return{...v,data:{x:v.x-o,y:v.y-r,enabled:{[m]:i,[h]:n}}}}}};var pa=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var o,r;let{placement:a,rects:s,platform:i,elements:n}=t,{apply:l=()=>{},...d}=qe(e,t),p=await i.detectOverflow(t,d),u=Se(a),h=Ue(a),m=be(a)==="y",{width:x,height:g}=s.floating,v,y;u==="top"||u==="bottom"?(v=u,y=h===(await(i.isRTL==null?void 0:i.isRTL(n.floating))?"start":"end")?"left":"right"):(y=u,v=h==="end"?"top":"bottom");let b=g-p.top-p.bottom,E=x-p.left-p.right,C=ye(g-p[v],b),O=ye(x-p[y],E),S=!t.middlewareData.shift,$=C,j=O;if((o=t.middlewareData.shift)!=null&&o.enabled.x&&(j=E),(r=t.middlewareData.shift)!=null&&r.enabled.y&&($=b),S&&!h){let te=X(p.left,0),Pe=X(p.right,0),he=X(p.top,0),Te=X(p.bottom,0);m?j=x-2*(te!==0||Pe!==0?te+Pe:X(p.left,p.right)):$=g-2*(he!==0||Te!==0?he+Te:X(p.top,p.bottom))}await l({...t,availableWidth:j,availableHeight:$});let J=await i.getDimensions(n.floating);return x!==J.width||g!==J.height?{reset:{rects:!0}}:{}}}};function Gt(){return typeof window<"u"}function ze(e){return ma(e)?(e.nodeName||"").toLowerCase():"#document"}function Q(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function pe(e){var t;return(t=(ma(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function ma(e){return Gt()?e instanceof Node||e instanceof Q(e).Node:!1}function ae(e){return Gt()?e instanceof Element||e instanceof Q(e).Element:!1}function ce(e){return Gt()?e instanceof HTMLElement||e instanceof Q(e).HTMLElement:!1}function ca(e){return!Gt()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof Q(e).ShadowRoot}var sn=new Set(["inline","contents"]);function Ye(e){let{overflow:t,overflowX:o,overflowY:r,display:a}=se(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+o)&&!sn.has(a)}var nn=new Set(["table","td","th"]);function ha(e){return nn.has(ze(e))}var ln=[":popover-open",":modal"];function At(e){return ln.some(t=>{try{return e.matches(t)}catch{return!1}})}var fn=["transform","translate","scale","rotate","perspective"],dn=["transform","translate","scale","rotate","perspective","filter"],un=["paint","layout","strict","content"];function Ze(e){let t=Xt(),o=ae(e)?se(e):e;return fn.some(r=>o[r]?o[r]!=="none":!1)||(o.containerType?o.containerType!=="normal":!1)||!t&&(o.backdropFilter?o.backdropFilter!=="none":!1)||!t&&(o.filter?o.filter!=="none":!1)||dn.some(r=>(o.willChange||"").includes(r))||un.some(r=>(o.contain||"").includes(r))}function xa(e){let t=Ae(e);for(;ce(t)&&!We(t);){if(Ze(t))return t;if(At(t))return null;t=Ae(t)}return null}function Xt(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}var pn=new Set(["html","body","#document"]);function We(e){return pn.has(ze(e))}function se(e){return Q(e).getComputedStyle(e)}function kt(e){return ae(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function Ae(e){if(ze(e)==="html")return e;let t=e.assignedSlot||e.parentNode||ca(e)&&e.host||pe(e);return ca(t)?t.host:t}function ga(e){let t=Ae(e);return We(t)?e.ownerDocument?e.ownerDocument.body:e.body:ce(t)&&Ye(t)?t:ga(t)}function ke(e,t,o){var r;t===void 0&&(t=[]),o===void 0&&(o=!0);let a=ga(e),s=a===((r=e.ownerDocument)==null?void 0:r.body),i=Q(a);if(s){let n=Kt(i);return t.concat(i,i.visualViewport||[],Ye(a)?a:[],n&&o?ke(n):[])}return t.concat(a,ke(a,[],o))}function Kt(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function wa(e){let t=se(e),o=parseFloat(t.width)||0,r=parseFloat(t.height)||0,a=ce(e),s=a?e.offsetWidth:o,i=a?e.offsetHeight:r,n=Ct(o)!==s||Ct(r)!==i;return n&&(o=s,r=i),{width:o,height:r,$:n}}function ko(e){return ae(e)?e:e.contextElement}function Qe(e){let t=ko(e);if(!ce(t))return ue(1);let o=t.getBoundingClientRect(),{width:r,height:a,$:s}=wa(t),i=(s?Ct(o.width):o.width)/r,n=(s?Ct(o.height):o.height)/a;return(!i||!Number.isFinite(i))&&(i=1),(!n||!Number.isFinite(n))&&(n=1),{x:i,y:n}}var cn=ue(0);function Ca(e){let t=Q(e);return!Xt()||!t.visualViewport?cn:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function mn(e,t,o){return t===void 0&&(t=!1),!o||t&&o!==Q(e)?!1:t}function Ne(e,t,o,r){t===void 0&&(t=!1),o===void 0&&(o=!1);let a=e.getBoundingClientRect(),s=ko(e),i=ue(1);t&&(r?ae(r)&&(i=Qe(r)):i=Qe(e));let n=mn(s,o,r)?Ca(s):ue(0),l=(a.left+n.x)/i.x,d=(a.top+n.y)/i.y,p=a.width/i.x,u=a.height/i.y;if(s){let h=Q(s),m=r&&ae(r)?Q(r):r,x=h,g=Kt(x);for(;g&&r&&m!==x;){let v=Qe(g),y=g.getBoundingClientRect(),b=se(g),E=y.left+(g.clientLeft+parseFloat(b.paddingLeft))*v.x,C=y.top+(g.clientTop+parseFloat(b.paddingTop))*v.y;l*=v.x,d*=v.y,p*=v.x,u*=v.y,l+=E,d+=C,x=Q(g),g=Kt(x)}}return He({width:p,height:u,x:l,y:d})}function Yt(e,t){let o=kt(e).scrollLeft;return t?t.left+o:Ne(pe(e)).left+o}function Sa(e,t){let o=e.getBoundingClientRect(),r=o.left+t.scrollLeft-Yt(e,o),a=o.top+t.scrollTop;return{x:r,y:a}}function hn(e){let{elements:t,rect:o,offsetParent:r,strategy:a}=e,s=a==="fixed",i=pe(r),n=t?At(t.floating):!1;if(r===i||n&&s)return o;let l={scrollLeft:0,scrollTop:0},d=ue(1),p=ue(0),u=ce(r);if((u||!u&&!s)&&((ze(r)!=="body"||Ye(i))&&(l=kt(r)),ce(r))){let m=Ne(r);d=Qe(r),p.x=m.x+r.clientLeft,p.y=m.y+r.clientTop}let h=i&&!u&&!s?Sa(i,l):ue(0);return{width:o.width*d.x,height:o.height*d.y,x:o.x*d.x-l.scrollLeft*d.x+p.x+h.x,y:o.y*d.y-l.scrollTop*d.y+p.y+h.y}}function xn(e){return Array.from(e.getClientRects())}function gn(e){let t=pe(e),o=kt(e),r=e.ownerDocument.body,a=X(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),s=X(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),i=-o.scrollLeft+Yt(e),n=-o.scrollTop;return se(r).direction==="rtl"&&(i+=X(t.clientWidth,r.clientWidth)-a),{width:a,height:s,x:i,y:n}}var ya=25;function yn(e,t){let o=Q(e),r=pe(e),a=o.visualViewport,s=r.clientWidth,i=r.clientHeight,n=0,l=0;if(a){s=a.width,i=a.height;let p=Xt();(!p||p&&t==="fixed")&&(n=a.offsetLeft,l=a.offsetTop)}let d=Yt(r);if(d<=0){let p=r.ownerDocument,u=p.body,h=getComputedStyle(u),m=p.compatMode==="CSS1Compat"&&parseFloat(h.marginLeft)+parseFloat(h.marginRight)||0,x=Math.abs(r.clientWidth-u.clientWidth-m);x<=ya&&(s-=x)}else d<=ya&&(s+=d);return{width:s,height:i,x:n,y:l}}var bn=new Set(["absolute","fixed"]);function vn(e,t){let o=Ne(e,!0,t==="fixed"),r=o.top+e.clientTop,a=o.left+e.clientLeft,s=ce(e)?Qe(e):ue(1),i=e.clientWidth*s.x,n=e.clientHeight*s.y,l=a*s.x,d=r*s.y;return{width:i,height:n,x:l,y:d}}function ba(e,t,o){let r;if(t==="viewport")r=yn(e,o);else if(t==="document")r=gn(pe(e));else if(ae(t))r=vn(t,o);else{let a=Ca(e);r={x:t.x-a.x,y:t.y-a.y,width:t.width,height:t.height}}return He(r)}function Aa(e,t){let o=Ae(e);return o===t||!ae(o)||We(o)?!1:se(o).position==="fixed"||Aa(o,t)}function wn(e,t){let o=t.get(e);if(o)return o;let r=ke(e,[],!1).filter(n=>ae(n)&&ze(n)!=="body"),a=null,s=se(e).position==="fixed",i=s?Ae(e):e;for(;ae(i)&&!We(i);){let n=se(i),l=Ze(i);!l&&n.position==="fixed"&&(a=null),(s?!l&&!a:!l&&n.position==="static"&&!!a&&bn.has(a.position)||Ye(i)&&!l&&Aa(e,i))?r=r.filter(p=>p!==i):a=n,i=Ae(i)}return t.set(e,r),r}function Cn(e){let{element:t,boundary:o,rootBoundary:r,strategy:a}=e,i=[...o==="clippingAncestors"?At(t)?[]:wn(t,this._c):[].concat(o),r],n=i[0],l=i.reduce((d,p)=>{let u=ba(t,p,a);return d.top=X(u.top,d.top),d.right=ye(u.right,d.right),d.bottom=ye(u.bottom,d.bottom),d.left=X(u.left,d.left),d},ba(t,n,a));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function Sn(e){let{width:t,height:o}=wa(e);return{width:t,height:o}}function An(e,t,o){let r=ce(t),a=pe(t),s=o==="fixed",i=Ne(e,!0,s,t),n={scrollLeft:0,scrollTop:0},l=ue(0);function d(){l.x=Yt(a)}if(r||!r&&!s)if((ze(t)!=="body"||Ye(a))&&(n=kt(t)),r){let m=Ne(t,!0,s,t);l.x=m.x+t.clientLeft,l.y=m.y+t.clientTop}else a&&d();s&&!r&&a&&d();let p=a&&!r&&!s?Sa(a,n):ue(0),u=i.left+n.scrollLeft-l.x-p.x,h=i.top+n.scrollTop-l.y-p.y;return{x:u,y:h,width:i.width,height:i.height}}function Ao(e){return se(e).position==="static"}function va(e,t){if(!ce(e)||se(e).position==="fixed")return null;if(t)return t(e);let o=e.offsetParent;return pe(e)===o&&(o=o.ownerDocument.body),o}function ka(e,t){let o=Q(e);if(At(e))return o;if(!ce(e)){let a=Ae(e);for(;a&&!We(a);){if(ae(a)&&!Ao(a))return a;a=Ae(a)}return o}let r=va(e,t);for(;r&&ha(r)&&Ao(r);)r=va(r,t);return r&&We(r)&&Ao(r)&&!Ze(r)?o:r||xa(e)||o}var kn=async function(e){let t=this.getOffsetParent||ka,o=this.getDimensions,r=await o(e.floating);return{reference:An(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function En(e){return se(e).direction==="rtl"}var Et={convertOffsetParentRelativeRectToViewportRelativeRect:hn,getDocumentElement:pe,getClippingRect:Cn,getOffsetParent:ka,getElementRects:kn,getClientRects:xn,getDimensions:Sn,getScale:Qe,isElement:ae,isRTL:En};function Ea(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function Pn(e,t){let o=null,r,a=pe(e);function s(){var n;clearTimeout(r),(n=o)==null||n.disconnect(),o=null}function i(n,l){n===void 0&&(n=!1),l===void 0&&(l=1),s();let d=e.getBoundingClientRect(),{left:p,top:u,width:h,height:m}=d;if(n||t(),!h||!m)return;let x=St(u),g=St(a.clientWidth-(p+h)),v=St(a.clientHeight-(u+m)),y=St(p),E={rootMargin:-x+"px "+-g+"px "+-v+"px "+-y+"px",threshold:X(0,ye(1,l))||1},C=!0;function O(S){let $=S[0].intersectionRatio;if($!==l){if(!C)return i();$?i(!1,$):r=setTimeout(()=>{i(!1,1e-7)},1e3)}$===1&&!Ea(d,e.getBoundingClientRect())&&i(),C=!1}try{o=new IntersectionObserver(O,{...E,root:a.ownerDocument})}catch{o=new IntersectionObserver(O,E)}o.observe(e)}return i(!0),s}function Pa(e,t,o,r){r===void 0&&(r={});let{ancestorScroll:a=!0,ancestorResize:s=!0,elementResize:i=typeof ResizeObserver=="function",layoutShift:n=typeof IntersectionObserver=="function",animationFrame:l=!1}=r,d=ko(e),p=a||s?[...d?ke(d):[],...ke(t)]:[];p.forEach(y=>{a&&y.addEventListener("scroll",o,{passive:!0}),s&&y.addEventListener("resize",o)});let u=d&&n?Pn(d,o):null,h=-1,m=null;i&&(m=new ResizeObserver(y=>{let[b]=y;b&&b.target===d&&m&&(m.unobserve(t),cancelAnimationFrame(h),h=requestAnimationFrame(()=>{var E;(E=m)==null||E.observe(t)})),o()}),d&&!l&&m.observe(d),m.observe(t));let x,g=l?Ne(e):null;l&&v();function v(){let y=Ne(e);g&&!Ea(g,y)&&o(),g=y,x=requestAnimationFrame(v)}return o(),()=>{var y;p.forEach(b=>{a&&b.removeEventListener("scroll",o),s&&b.removeEventListener("resize",o)}),u?.(),(y=m)==null||y.disconnect(),m=null,l&&cancelAnimationFrame(x)}}var Ta=da;var La=ua,Ra=fa,Eo=pa;var _a=la;var $a=(e,t,o)=>{let r=new Map,a={platform:Et,...o},s={...a.platform,_c:r};return na(e,t,{...a,platform:s})};function Da(e){return Tn(e)}function Po(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function Tn(e){for(let t=e;t;t=Po(t))if(t instanceof Element&&getComputedStyle(t).display==="none")return null;for(let t=Po(e);t;t=Po(t)){if(!(t instanceof Element))continue;let o=getComputedStyle(t);if(o.display!=="contents"&&(o.position!=="static"||Ze(o)||t.tagName==="BODY"))return t}return null}var Ee={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Zt=e=>(...t)=>({_$litDirective$:e,values:t}),Je=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,o,r){this._$Ct=t,this._$AM=o,this._$Ci=r}_$AS(t,o){return this.update(t,o)}update(t,o){return this.render(...o)}};var ie=Zt(class extends Je{constructor(e){if(super(e),e.type!==Ee.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(r=>r!=="")));for(let r in t)t[r]&&!this.nt?.has(r)&&this.st.add(r);return this.render(t)}let o=e.element.classList;for(let r of this.st)r in t||(o.remove(r),this.st.delete(r));for(let r in t){let a=!!t[r];a===this.st.has(r)||this.nt?.has(r)||(a?(o.add(r),this.st.add(r)):(o.remove(r),this.st.delete(r)))}return Y}});function Oa(e){return e!==null&&typeof e=="object"&&"getBoundingClientRect"in e&&("contextElement"in e?e instanceof Element:!0)}var Qt=globalThis?.HTMLElement?.prototype.hasOwnProperty("popover"),L=class extends H{constructor(){super(...arguments),this.localize=new ge(this),this.active=!1,this.placement="top",this.boundary="viewport",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl&&this.popup){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),o=this.placement.includes("top")||this.placement.includes("bottom"),r=0,a=0,s=0,i=0,n=0,l=0,d=0,p=0;o?e.top<t.top?(r=e.left,a=e.bottom,s=e.right,i=e.bottom,n=t.left,l=t.top,d=t.right,p=t.top):(r=t.left,a=t.bottom,s=t.right,i=t.bottom,n=e.left,l=e.top,d=e.right,p=e.top):e.left<t.left?(r=e.right,a=e.top,s=t.left,i=t.top,n=e.right,l=e.bottom,d=t.left,p=t.bottom):(r=t.right,a=t.top,s=e.left,i=e.top,n=t.right,l=t.bottom,d=e.left,p=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${r}px`),this.style.setProperty("--hover-bridge-top-left-y",`${a}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${i}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${n}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${p}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){let e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||Oa(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.start()}start(){!this.anchorEl||!this.active||!this.isConnected||(this.popup?.showPopover?.(),this.cleanup=Pa(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.popup?.hidePopover?.(),this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl||!this.popup)return;let e=[Ta({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Eo({apply:({rects:r})=>{let a=this.sync==="width"||this.sync==="both",s=this.sync==="height"||this.sync==="both";this.popup.style.width=a?`${r.reference.width}px`:"",this.popup.style.height=s?`${r.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height="");let t;Qt&&!Oa(this.anchor)&&this.boundary==="scroll"&&(t=ke(this.anchorEl).filter(r=>r instanceof Element)),this.flip&&e.push(Ra({boundary:this.flipBoundary||t,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(La({boundary:this.shiftBoundary||t,padding:this.shiftPadding})),this.autoSize?e.push(Eo({boundary:this.autoSizeBoundary||t,padding:this.autoSizePadding,apply:({availableWidth:r,availableHeight:a})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${a}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${r}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(_a({element:this.arrowEl,padding:this.arrowPadding}));let o=Qt?r=>Et.getOffsetParent(r,Da):Et.getOffsetParent;$a(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:Qt?"absolute":"fixed",platform:{...Et,getOffsetParent:o}}).then(({x:r,y:a,middlewareData:s,placement:i})=>{let n=this.localize.dir()==="rtl",l={top:"bottom",right:"left",bottom:"top",left:"right"}[i.split("-")[0]];if(this.setAttribute("data-current-placement",i),Object.assign(this.popup.style,{left:`${r}px`,top:`${a}px`}),this.arrow){let d=s.arrow.x,p=s.arrow.y,u="",h="",m="",x="";if(this.arrowPlacement==="start"){let g=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";u=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",h=n?g:"",x=n?"":g}else if(this.arrowPlacement==="end"){let g=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";h=n?"":g,x=n?g:"",m=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(x=typeof d=="number"?"calc(50% - var(--arrow-size-diagonal))":"",u=typeof p=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(x=typeof d=="number"?`${d}px`:"",u=typeof p=="number"?`${p}px`:"");Object.assign(this.arrowEl.style,{top:u,right:h,bottom:m,left:x,[l]:"calc(var(--arrow-base-offset) - var(--arrow-size-diagonal))"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.dispatchEvent(new zr)}render(){return T`
...
lucide.createIcons({icons});\``);if(typeof r>"u")throw new Error("`createIcons()` only works in a browser environment.");if(Array.from(r.querySelectorAll(`[${t}]`)).forEach(i=>Ro(i,{nameAttr:t,icons:e,attrs:o})),a&&Array.from(r.querySelectorAll("template")).forEach(n=>Oo({icons:e,nameAttr:t,attrs:o,root:n.content,inTemplates:a})),t==="data-lucide"){let i=r.querySelectorAll("[icon-name]");i.length>0&&(console.warn("[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide"),Array.from(i).forEach(n=>Ro(n,{nameAttr:"icon-name",icons:e,attrs:o})))}};var Xa="data-icon";function Ka([e,t]){let o=document.createElement("span");return o.setAttribute(Xa,t),o.setAttribute("slot",e),o}function ao(e){Oo({icons:{ChevronRight:_o,Link:$o,Unlink:Do},attrs:{width:16,height:16},nameAttr:Xa,root:e?.root})}var so={REST:"rest",SUCCESS:"success"},Ya,Za,Qa,Ja,es,ts,os,rs,as,ss,is,ns,ls,A,Mo,Bo,Fo,Io,qo,Uo,Ho,zo,Wo,No,Vo;ls=[U("copy-url")];var W=class extends(ns=oe,is=[P('slot[name="copy-icon"]')],ss=[P('slot[name="success-icon"]')],as=[c()],rs=[c({attribute:"copy-label"})],os=[c()],ts=[c()],es=[c()],Ja=[c({attribute:"success-label"})],Qa=[c({attribute:"tooltip-placement"})],Za=[Z()],Ya=[Z()],ns){constructor(){super(...arguments);_(this,Mo,w(A,8,this)),w(A,11,this);_(this,Bo,w(A,12,this)),w(A,15,this);_(this,Fo,w(A,16,this,"")),w(A,19,this);_(this,Io,w(A,20,this,"Copy link")),w(A,23,this);_(this,qo,w(A,24,this,1e3)),w(A,27,this);_(this,Uo,w(A,28,this,Cr)),w(A,31,this);_(this,Ho,w(A,32,this,wr)),w(A,35,this);_(this,zo,w(A,36,this,"Copied")),w(A,39,this);_(this,Wo,w(A,40,this,"top")),w(A,43,this);_(this,No,w(A,44,this,!1)),w(A,47,this);_(this,Vo,w(A,48,this,so.REST)),w(A,51,this)}async handleCopy(){let o,r;this.isCopying||(this.isCopying=!0,o=new URL(window.location.href),o.hash=this.from,r=o.href,r&&(await navigator.clipboard.writeText(r),await this.animateIcon()))}firstUpdated(){super.firstUpdated(),ao({root:this.shadowRoot})}get label(){return this.status===so.SUCCESS?this.successLabel:this.copyLabel}render(){return T`
    ...
    `}async animateIcon(){let{matches:o}=window.matchMedia("(prefers-reduced-motion: reduce)"),r=o?this.showAnimationReducedMotion:this.showAnimation;this.copyIcon.hidden=!1,this.status=so.SUCCESS,await this.successIcon.animate(r.keyframes,r.options).finished,setTimeout(()=>{document.documentElement.style.setProperty("--jsdoc-copy-icon-opacity",0),this.copyIcon.hidden=!0,this.isCopying=!1,this.status=so.REST},this.feedbackDuration)}};A=Rt(ns),Mo=new WeakMap,Bo=new WeakMap,Fo=new WeakMap,Io=new WeakMap,qo=new WeakMap,Uo=new WeakMap,Ho=new WeakMap,zo=new WeakMap,Wo=new WeakMap,No=new WeakMap,Vo=new WeakMap,I(A,4,"copyIcon",is,W,Mo),I(A,4,"successIcon",ss,W,Bo),I(A,4,"from",as,W,Fo),I(A,4,"copyLabel",rs,W,Io),I(A,4,"feedbackDuration",os,W,qo),I(A,4,"showAnimation",ts,W,Uo),I(A,4,"showAnimationReducedMotion",es,W,Ho),I(A,4,"successLabel",Ja,W,zo),I(A,4,"tooltipPlacement",Qa,W,Wo),I(A,4,"isCopying",Za,W,No),I(A,4,"status",Ya,W,Vo),W=I(A,0,"CopyUrl",ls,W),_t(W,"styles",[R`
      :host {
    ...
    `]),w(A,1,W);var Rn=["copy-url","jsdoc-outline","wa-details","wa-icon","wa-tree","wa-tree-item"];(async()=>{let e=Rn.filter(t=>document.querySelector(t));await Promise.allSettled(e.map(t=>customElements.whenDefined(t)));for(let t of e)for(let o of document.querySelectorAll(t))o.classList.add("ready")})();var cs=Ti(us(),1),ps="--navbar-scroll-margin";function jo(e){let t=getComputedStyle(document.body),o;return e&&(o=getComputedStyle(e).getPropertyValue(ps)),o||(o=t.getPropertyValue(ps)),o=Number(o.replace("rem",""))*parseFloat(t.fontSize),Math.ceil(o/5)*5}(()=>{let e={PAGE_DOWN:"PageDown",PAGE_UP:"PageUp",SPACE:"Space"};function t(s,i){let n=jo(s);return i-n}function o(s){(0,cs.default)({durationMs:200,startValue:window.scrollY,endValue:s,onStep:i=>window.scroll({behavior:"instant",top:i})})}function r(s,i,n){let l;i&&(l=document.getElementById(i),l&&(s.preventDefault(),o(t(l,l.offsetTop)),window.history.pushState(null,null,n)))}function a(s){return s.substring(1)}window.addEventListener("load",s=>{let i=a(document.location.hash);r(s,i,document.location.href)}),window.addEventListener("hashchange",s=>{let i=new URL(s.newURL),n=a(i.hash);r(s,n,i.hash)}),document.addEventListener("keydown",s=>{let i=s.code,n;i!==e.SPACE&&i!==e.PAGE_DOWN&&i!==e.PAGE_UP||(s.preventDefault(),s.stopImmediatePropagation(),n=t(null,window.innerHeight),i===e.PAGE_UP?o(window.scrollY-n):o(window.scrollY+n))})})();function $n(e){var t=typeof e;return e!=null&&(t=="object"||t=="function")}var je=$n;var Dn=typeof global=="object"&&global&&global.Object===Object&&global,ms=Dn;var On=typeof self=="object"&&self&&self.Object===Object&&self,Mn=ms||On||Function("return this")(),io=Mn;var Bn=function(){return io.Date.now()},no=Bn;var Fn=/\s/;function In(e){for(var t=e.length;t--&&Fn.test(e.charAt(t)););return t}var hs=In;var qn=/^\s+/;function Un(e){return e&&e.slice(0,hs(e)+1).replace(qn,"")}var xs=Un;var Hn=io.Symbol,rt=Hn;var gs=Object.prototype,zn=gs.hasOwnProperty,Wn=gs.toString,Pt=rt?rt.toStringTag:void 0;function Nn(e){var t=zn.call(e,Pt),o=e[Pt];try{e[Pt]=void 0;var r=!0}catch{}var a=Wn.call(e);return r&&(t?e[Pt]=o:delete e[Pt]),a}var ys=Nn;var Vn=Object.prototype,jn=Vn.toString;function Gn(e){return jn.call(e)}var bs=Gn;var Xn="[object Null]",Kn="[object Undefined]",vs=rt?rt.toStringTag:void 0;function Yn(e){return e==null?e===void 0?Kn:Xn:vs&&vs in Object(e)?ys(e):bs(e)}var ws=Yn;function Zn(e){return e!=null&&typeof e=="object"}var Cs=Zn;var Qn="[object Symbol]";function Jn(e){return typeof e=="symbol"||Cs(e)&&ws(e)==Qn}var Ss=Jn;var As=NaN,el=/^[-+]0x[0-9a-f]+$/i,tl=/^0b[01]+$/i,ol=/^0o[0-7]+$/i,rl=parseInt;function al(e){if(typeof e=="number")return e;if(Ss(e))return As;if(je(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=je(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=xs(e);var o=tl.test(e);return o||ol.test(e)?rl(e.slice(2),o?2:8):el.test(e)?As:+e}var Go=al;var sl="Expected a function",il=Math.max,nl=Math.min;function ll(e,t,o){var r,a,s,i,n,l,d=0,p=!1,u=!1,h=!0;if(typeof e!="function")throw new TypeError(sl);t=Go(t)||0,je(o)&&(p=!!o.leading,u="maxWait"in o,s=u?il(Go(o.maxWait)||0,t):s,h="trailing"in o?!!o.trailing:h);function m(S){var $=r,j=a;return r=a=void 0,d=S,i=e.apply(j,$),i}function x(S){return d=S,n=setTimeout(y,t),p?m(S):i}function g(S){var $=S-l,j=S-d,J=t-$;return u?nl(J,s-j):J}function v(S){var $=S-l,j=S-d;return l===void 0||$>=t||$<0||u&&j>=s}function y(){var S=no();if(v(S))return b(S);n=setTimeout(y,g(S))}function b(S){return n=void 0,h&&r?m(S):(r=a=void 0,i)}function E(){n!==void 0&&clearTimeout(n),d=0,r=l=a=n=void 0}function C(){return n===void 0?i:b(no())}function O(){var S=no(),$=v(S);if(r=arguments,a=this,l=S,$){if(n===void 0)return x(l);if(u)return clearTimeout(n),n=setTimeout(y,t),m(l)}return n===void 0&&(n=setTimeout(y,t)),i}return O.cancel=E,O.flush=C,O}var ks=ll;var fl="Expected a function";function dl(e,t,o){var r=!0,a=!0;if(typeof e!="function")throw new TypeError(fl);return je(o)&&(r="leading"in o?!!o.leading:r,a="trailing"in o?!!o.trailing:a),ks(e,t,{leading:r,maxWait:t,trailing:a})}var Es=dl;var ul="h2, h3";function Bs(e,t,o=[]){for(let r of e)r instanceof Comment||(r instanceof Text?o.push(r.textContent):r.matches(t)&&Bs(r.childNodes,t,o));return o}function tr(e){if(e?.localName.startsWith("h")){let t=e.localName.substring(1),o=parseInt(t,10);if(o>=1&&o<=6)return o}return null}function pl(e){return t=>{for(let o of t)if(o.target.parentElement.closest(e.levels)){e.updateTree();break}}}function cl(e,t){let o=`:not(copy-url, .${t.hideFromNavClass})`,r;return e?(r=Bs(e.childNodes,o),r.join("").trim()):null}var or=class{constructor(t,o){this.children=[],this.hideFromNav=o.isHidden(t),this.id=t?.id,this.level=tr(t),this.text=cl(t,o)}},Ps,Ts,Ls,Rs,_s,$s,Ds,Os,Ms,M,Xo,Ko,Yo,Zo,Qo,Jo,er,at,st,it,nt,lt,F,rr,Fs,Is,qs,Us,ar,Hs,sr,zs;Ms=[U("jsdoc-outline")];var ee=class extends(Os=oe,Ds=[P('slot[name="contents"]')],$s=[c({attribute:"hide-from-nav-class"})],_s=[c({reflect:!0})],Rs=[Jr("a")],Ls=[P('slot[name="title"]')],Ts=[c({reflect:!0})],Ps=[c()],Os){constructor(){super();_(this,F);_(this,Xo,w(M,8,this)),w(M,11,this);_(this,Ko,w(M,12,this,"hide-from-nav")),w(M,15,this);_(this,Yo,w(M,16,this,ul)),w(M,19,this);_(this,Zo,w(M,20,this)),w(M,23,this);_(this,Qo,w(M,24,this)),w(M,27,this);_(this,Jo,w(M,28,this,"On this page")),w(M,31,this);_(this,er,w(M,32,this)),w(M,35,this);_(this,at);_(this,st);_(this,it);_(this,nt);_(this,lt);xe(this,at,null),xe(this,st,new WeakMap),xe(this,it,null),xe(this,lt,new WeakSet)}connectedCallback(){super.connectedCallback(),this.updateTree()}firstUpdated(){super.firstUpdated(),xe(this,it,new MutationObserver(pl(this))),K(this,F,Is).call(this);let o=jo(),r=o/2;xe(this,at,new IntersectionObserver(a=>K(this,F,Fs).call(this,a,de(this,lt)),{rootMargin:`-${o}px 0px -${r}px 0px`})),K(this,F,sr).call(this),K(this,F,qs).call(this)}isHidden(o){return Array.from(o.classList).includes(this.hideFromNavClass)}render(){return this.tree?T`
    ...
    `:T``}updateTree(){return de(this,nt)||xe(this,nt,Es(K(this,F,zs),500)),de(this,nt).call(this)}};M=Rt(Os),Xo=new WeakMap,Ko=new WeakMap,Yo=new WeakMap,Zo=new WeakMap,Qo=new WeakMap,Jo=new WeakMap,er=new WeakMap,at=new WeakMap,st=new WeakMap,it=new WeakMap,nt=new WeakMap,lt=new WeakMap,F=new WeakSet,rr=function(o,r){let a=[];for(r??(r={count:0});o.length;){let s=o.shift(),i,n;this.isHidden(s)||(n=new or(s,this),r.count++,i=K(this,F,Hs).call(this,o,s),i.length&&(n.children=K(this,F,rr).call(this,i,r)),a.push(n))}return r.count<=1?null:a},Fs=function(o,r){o.forEach(a=>{a.isIntersecting?r.add(a.target):r.delete(a.target)}),K(this,F,sr).call(this)},Is=function(){de(this,it).observe(document.body,{attributes:!0,characterData:!0,childList:!0,subtree:!0})},qs=function(){for(let o of Array.from(this.links)){let r=o.hash.slice(1),a=r?document.getElementById(r):null;a&&(de(this,st).set(o,a),de(this,at).observe(a))}},Us=function(o){return o?T`
...
`;var Ns=class extends Event{constructor(){super("wa-invalid",{bubbles:!0,cancelable:!1,composed:!0})}};var ml=()=>({observedAttributes:["custom-error"],checkValidity(e){let t={message:"",isValid:!0,invalidKeys:[]};return e.customError&&(t.message=e.customError,t.isValid=!1,t.invalidKeys=["customError"]),t}}),ne=class extends H{constructor(){super(),this.name=null,this.disabled=!1,this.required=!1,this.assumeInteractionOn=["input"],this.validators=[],this.valueHasChanged=!1,this.hasInteracted=!1,this.customError=null,this.emittedEvents=[],this.emitInvalid=e=>{e.target===this&&(this.hasInteracted=!0,this.dispatchEvent(new Ns))},this.handleInteraction=e=>{let t=this.emittedEvents;t.includes(e.type)||t.push(e.type),t.length===this.assumeInteractionOn?.length&&(this.hasInteracted=!0)},this.addEventListener("invalid",this.emitInvalid)}static get validators(){return[ml()]}static get observedAttributes(){let e=new Set(super.observedAttributes||[]);for(let t of this.validators)if(t.observedAttributes)for(let o of t.observedAttributes)e.add(o);return[...e]}connectedCallback(){super.connectedCallback(),this.updateValidity(),this.assumeInteractionOn.forEach(e=>{this.addEventListener(e,this.handleInteraction)})}firstUpdated(...e){super.firstUpdated(...e),this.updateValidity()}willUpdate(e){if(!!1&&e.has("customError")&&(this.customError||(this.customError=null),this.setCustomValidity(this.customError||"")),e.has("value")||e.has("disabled")||e.has("defaultValue")){let t=this.value;if(Array.isArray(t)){if(this.name){let o=new FormData;for(let r of t)o.append(this.name,r);this.setValue(o,o)}}else this.setValue(t,t)}e.has("disabled")&&(this.customStates.set("disabled",this.disabled),(this.hasAttribute("disabled")||!!1&&!this.matches(":disabled"))&&this.toggleAttribute("disabled",this.disabled)),super.willUpdate(e),this.updateValidity()}get labels(){return this.internals.labels}getForm(){return this.internals.form}set form(e){e?this.setAttribute("form",e):this.removeAttribute("form")}get form(){return this.internals.form}get validity(){return this.internals.validity}get willValidate(){return this.internals.willValidate}get validationMessage(){return this.internals.validationMessage}checkValidity(){return this.updateValidity(),this.internals.checkValidity()}reportValidity(){return this.updateValidity(),this.hasInteracted=!0,this.internals.reportValidity()}get validationTarget(){return this.input||void 0}setValidity(...e){let t=e[0],o=e[1],r=e[2];r||(r=this.validationTarget),this.internals.setValidity(t,o,r||void 0),this.requestUpdate("validity"),this.setCustomStates()}setCustomStates(){let e=!!this.required,t=this.internals.validity.valid,o=this.hasInteracted;this.customStates.set("required",e),this.customStates.set("optional",!e),this.customStates.set("invalid",!t),this.customStates.set("valid",t),this.customStates.set("user-invalid",!t&&o),this.customStates.set("user-valid",t&&o)}setCustomValidity(e){if(!e){this.customError=null,this.setValidity({});return}this.customError=e,this.setValidity({customError:!0},e,this.validationTarget)}formResetCallback(){this.resetValidity(),this.hasInteracted=!1,this.valueHasChanged=!1,this.emittedEvents=[],this.updateValidity()}formDisabledCallback(e){this.disabled=e,this.updateValidity()}formStateRestoreCallback(e,t){this.value=e,t==="restore"&&this.resetValidity(),this.updateValidity()}setValue(...e){let[t,o]=e;this.internals.setFormValue(t,o)}get allValidators(){let e=this.constructor.validators||[],t=this.validators||[];return[...e,...t]}resetValidity(){this.setCustomValidity(""),this.setValidity({})}updateValidity(){if(this.disabled||this.hasAttribute("disabled")||!this.willValidate){this.resetValidity();return}let e=this.allValidators;if(!e?.length)return;let t={customError:!!this.customError},o=this.validationTarget||this.input||void 0,r="";for(let a of e){let{isValid:s,message:i,invalidKeys:n}=a.checkValidity(this);s||(r||(r=i),n?.length>=0&&n.forEach(l=>t[l]=!0))}r||(r=this.validationMessage),this.setValidity(t,r,o)}};ne.formAssociated=!0;f([c({reflect:!0})],ne.prototype,"name",2);f([c({type:Boolean})],ne.prototype,"disabled",2);f([c({state:!0,attribute:!1})],ne.prototype,"valueHasChanged",2);f([c({state:!0,attribute:!1})],ne.prototype,"hasInteracted",2);f([c({attribute:"custom-error",reflect:!0})],ne.prototype,"customError",2);f([c({attribute:!1,state:!0,type:Object})],ne.prototype,"validity",1);var V=class extends H{constructor(){super(...arguments),this.localize=new ge(this),this.animationGeneration=0,this.isAnimating=!1,this.open=!1,this.disabled=!1,this.appearance="outlined",this.iconPlacement="end"}disconnectedCallback(){super.disconnectedCallback(),this.detailsObserver?.disconnect()}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(let t of e)t.type==="attributes"&&t.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}updated(e){e.has("isAnimating")&&this.customStates.set("animating",this.isAnimating)}handleSummaryClick(e){e.composedPath().some(r=>{if(!(r instanceof HTMLElement))return!1;let a=r.tagName?.toLowerCase();return["a","button","input","textarea","select"].includes(a)?!0:r instanceof ne?!("disabled"in r)||!r.disabled:!1})||(e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus()))}handleSummaryKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key==="ArrowUp"||e.key==="ArrowLeft")&&(e.preventDefault(),this.hide()),(e.key==="ArrowDown"||e.key==="ArrowRight")&&(e.preventDefault(),this.show())}closeOthersWithSameName(){if(!this.name)return;this.getRootNode().querySelectorAll(`wa-details[name="${this.name}"]`).forEach(o=>{o!==this&&o.open&&(o.open=!1)})}async handleOpenChange(){this.animationGeneration++;let e=this.animationGeneration;if(this.open){this.details.open=!0;let t=new Jt;if(this.dispatchEvent(t),t.defaultPrevented){this.open=!1,this.details.open=!1;return}this.closeOthersWithSameName(),this.isAnimating=!0;let o=ot(getComputedStyle(this.body).getPropertyValue("--show-duration"));if(await tt(this.body,[{height:"0",opacity:"0"},{height:`${this.body.scrollHeight}px`,opacity:"1"}],{duration:o,easing:"linear"}),this.animationGeneration!==e)return;this.body.style.height="auto",this.isAnimating=!1,this.dispatchEvent(new oo)}else{let t=new eo;if(this.dispatchEvent(t),t.defaultPrevented){this.details.open=!0,this.open=!0;return}this.isAnimating=!0;let o=ot(getComputedStyle(this.body).getPropertyValue("--hide-duration"));if(await tt(this.body,[{height:`${this.body.scrollHeight}px`,opacity:"1"},{height:"0",opacity:"0"}],{duration:o,easing:"linear"}),this.animationGeneration!==e)return;this.body.style.height="0",this.isAnimating=!1,this.details.open=!1,this.dispatchEvent(new to)}}async show(){if(!(this.open||this.disabled))return this.open=!0,et(this,"wa-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,et(this,"wa-after-hide")}render(){let e=this.hasUpdated?this.localize.dir()==="rtl":this.dir==="rtl";return T`
      <details part="base">
        ...
        <div
          class=${ie({body:!0,animating:this.isAnimating})}
          role="region"
...
`;var Xs={};var hl="",ir="";function Ks(){return hl.replace(/\/$/,"")}function xl(e){ir=e}function Ys(){if(!ir){let e=document.querySelector("[data-fa-kit-code]");e&&xl(e.getAttribute("data-fa-kit-code")||"")}return ir}var Zs="7.2.0";function gl(e,t,o){let r="solid";return t==="chisel"&&(r="chisel-regular"),t==="etch"&&(r="etch-solid"),t==="graphite"&&(r="graphite-thin"),t==="jelly"&&(r="jelly-regular",o==="duo-regular"&&(r="jelly-duo-regular"),o==="fill-regular"&&(r="jelly-fill-regular")),t==="jelly-duo"&&(r="jelly-duo-regular"),t==="jelly-fill"&&(r="jelly-fill-regular"),t==="notdog"&&(o==="solid"&&(r="notdog-solid"),o==="duo-solid"&&(r="notdog-duo-solid")),t==="notdog-duo"&&(r="notdog-duo-solid"),t==="slab"&&((o==="solid"||o==="regular")&&(r="slab-regular"),o==="press-regular"&&(r="slab-press-regular")),t==="slab-press"&&(r="slab-press-regular"),t==="thumbprint"&&(r="thumbprint-light"),t==="utility"&&(r="utility-semibold"),t==="utility-duo"&&(r="utility-duo-semibold"),t==="utility-fill"&&(r="utility-fill-semibold"),t==="whiteboard"&&(r="whiteboard-semibold"),t==="classic"&&(o==="thin"&&(r="thin"),o==="light"&&(r="light"),o==="regular"&&(r="regular"),o==="solid"&&(r="solid")),t==="duotone"&&(o==="thin"&&(r="duotone-thin"),o==="light"&&(r="duotone-light"),o==="regular"&&(r="duotone-regular"),o==="solid"&&(r="duotone")),t==="sharp"&&(o==="thin"&&(r="sharp-thin"),o==="light"&&(r="sharp-light"),o==="regular"&&(r="sharp-regular"),o==="solid"&&(r="sharp-solid")),t==="sharp-duotone"&&(o==="thin"&&(r="sharp-duotone-thin"),o==="light"&&(r="sharp-duotone-light"),o==="regular"&&(r="sharp-duotone-regular"),o==="solid"&&(r="sharp-duotone-solid")),t==="brands"&&(r="brands"),r}function yl(e,t,o){let r=gl(e,t,o),a=Ks();if(a)return`${a}/${r}/${e}.svg`;let s=Ys();return s.length>0?`https://ka-p.fontawesome.com/releases/v${Zs}/svgs/${r}/${e}.svg?token=${encodeURIComponent(s)}`:`https://ka-f.fontawesome.com/releases/v${Zs}/svgs/${r}/${e}.svg`}var bl={name:"default",resolver:(e,t="classic",o="solid")=>yl(e,t,o),mutator:(e,t)=>{if(t?.family&&!e.hasAttribute("data-duotone-initialized")){let{family:o,variant:r}=t;if(o==="duotone"||o==="sharp-duotone"||o==="notdog-duo"||o==="notdog"&&r==="duo-solid"||o==="jelly-duo"||o==="jelly"&&r==="duo-regular"||o==="utility-duo"||o==="thumbprint"){let a=[...e.querySelectorAll("path")],s=a.find(n=>!n.hasAttribute("opacity")),i=a.find(n=>n.hasAttribute("opacity"));if(!s||!i)return;if(s.setAttribute("data-duotone-primary",""),i.setAttribute("data-duotone-secondary",""),t.swapOpacity&&s&&i){let n=i.getAttribute("opacity")||"0.4";s.style.setProperty("--path-opacity",n),i.style.setProperty("--path-opacity","1")}e.setAttribute("data-duotone-initialized","")}}}},Qs=bl;var vl="classic",wl=[Qs,Xs],nr=[];function Js(e){nr.push(e)}function ei(e){nr=nr.filter(t=>t!==e)}function lo(e){return wl.find(t=>t.name===e)}function ti(){return vl}var{I:Nc}=qr;var oi=(e,t)=>t===void 0?e?._$litType$!==void 0:e?._$litType$===t;var ri=e=>e.strings===void 0;var Cl={},ai=(e,t=Cl)=>e._$AH=t;var Tt=Symbol(),fo=Symbol(),lr,fr=new Map,N=class extends H{constructor(){super(...arguments),this.svg=null,this.autoWidth=!1,this.swapOpacity=!1,this.label="",this.library="default",this.rotate=0,this.resolveIcon=async(e,t)=>{let o;if(t?.spriteSheet){this.hasUpdated||await this.updateComplete,this.svg=T`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,await this.updateComplete;let r=this.shadowRoot.querySelector("[part='svg']");return typeof t.mutator=="function"&&t.mutator(r,this),this.svg}try{if(o=await fetch(e,{mode:"cors"}),!o.ok)return o.status===410?Tt:fo}catch{return fo}try{let r=document.createElement("div");r.innerHTML=await o.text();let a=r.firstElementChild;if(a?.tagName?.toLowerCase()!=="svg")return Tt;lr||(lr=new DOMParser);let i=lr.parseFromString(a.outerHTML,"text/html").body.querySelector("svg");return i?(i.part.add("svg"),document.adoptNode(i)):Tt}catch{return Tt}}}connectedCallback(){super.connectedCallback(),Js(this)}firstUpdated(e){super.firstUpdated(e),this.hasAttribute("rotate")&&this.style.setProperty("--rotate-angle",`${this.rotate}deg`),this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),ei(this)}async getIconSource(){let e=lo(this.library),t=this.family||ti();if(this.name&&e){let o;try{o=await e.resolver(this.name,t,this.variant,this.autoWidth)}catch{o=void 0}return{url:o,fromLibrary:!0}}return{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){let{url:e,fromLibrary:t}=await this.getIconSource(),o=t?lo(this.library):void 0;if(!e){this.svg=null;return}let r=fr.get(e);r||(r=this.resolveIcon(e,o),fr.set(e,r));let a=await r;a===fo&&fr.delete(e);let s=await this.getIconSource();if(e===s.url){if(oi(a)){this.svg=a;return}switch(a){case fo:case Tt:this.svg=null,this.dispatchEvent(new Vs);break;default:this.svg=a.cloneNode(!0),o?.mutator?.(this.svg,this),this.dispatchEvent(new js)}}}updated(e){super.updated(e);let t=lo(this.library);this.hasAttribute("rotate")&&this.style.setProperty("--rotate-angle",`${this.rotate}deg`);let o=this.shadowRoot?.querySelector("svg");o&&t?.mutator?.(o,this)}render(){return this.hasUpdated?this.svg:T`<svg part="svg" width="16" height="16"></svg>`}};N.css=Gs;f([Z()],N.prototype,"svg",2);f([c({reflect:!0})],N.prototype,"name",2);f([c({reflect:!0})],N.prototype,"family",2);f([c({reflect:!0})],N.prototype,"variant",2);f([c({attribute:"auto-width",type:Boolean,reflect:!0})],N.prototype,"autoWidth",2);f([c({attribute:"swap-opacity",type:Boolean,reflect:!0})],N.prototype,"swapOpacity",2);f([c()],N.prototype,"src",2);f([c()],N.prototype,"label",2);f([c({reflect:!0})],N.prototype,"library",2);f([c({type:Number,reflect:!0})],N.prototype,"rotate",2);f([c({type:String,reflect:!0})],N.prototype,"flip",2);f([c({type:String,reflect:!0})],N.prototype,"animation",2);f([D("label")],N.prototype,"handleLabelChange",1);f([D(["family","name","library","variant","src","autoWidth","swapOpacity"],{waitUntilFirstUpdate:!0})],N.prototype,"setIcon",1);N=f([U("wa-icon")],N);var si=class extends Event{constructor(e){super("wa-selection-change",{bubbles:!0,cancelable:!1,composed:!0}),this.detail=e}};var ii=R`
  :host {
    /*
...
`;var ni=class extends Event{constructor(){super("wa-lazy-change",{bubbles:!0,cancelable:!1,composed:!0})}};var li=class extends Event{constructor(){super("wa-lazy-load",{bubbles:!0,cancelable:!1,composed:!0})}};var fi=class extends Event{constructor(){super("wa-collapse",{bubbles:!0,cancelable:!1,composed:!0})}};var di=class extends Event{constructor(){super("wa-expand",{bubbles:!0,cancelable:!1,composed:!0})}};var ui=class extends Event{constructor(){super("wa-after-collapse",{bubbles:!0,cancelable:!1,composed:!0})}};var pi=class extends Event{constructor(){super("wa-after-expand",{bubbles:!0,cancelable:!1,composed:!0})}};var ci=R`
  :host {
...
`;var Lt=Zt(class extends Je{constructor(e){if(super(e),e.type!==Ee.PROPERTY&&e.type!==Ee.ATTRIBUTE&&e.type!==Ee.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ri(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Y||t===q)return t;let o=e.element,r=e.name;if(e.type===Ee.PROPERTY){if(t===o[r])return Y}else if(e.type===Ee.BOOLEAN_ATTRIBUTE){if(!!t===o.hasAttribute(r))return Y}else if(e.type===Ee.ATTRIBUTE&&o.getAttribute(r)===t+"")return Y;return ai(e),t}});function dr(e,t,o){return e?t(e):o?.(e)}var k=class extends H{constructor(){super(...arguments),this.localize=new ge(this),this.indeterminate=!1,this.isLeaf=!1,this.loading=!1,this.selectable=!1,this.expanded=!1,this.selected=!1,this.disabled=!1,this.lazy=!1,this.animationGeneration=0}static isTreeItem(e){return e instanceof Element&&e.getAttribute("role")==="treeitem"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","treeitem"),this.setAttribute("tabindex","-1"),this.isNestedItem()&&(this.slot="children"),this.updateIndentation()}firstUpdated(){this.childrenContainer.hidden=!this.expanded,this.childrenContainer.style.height=this.expanded?"auto":"0",this.isLeaf=!this.lazy&&this.getChildrenItems().length===0,this.handleExpandedChange()}async animateCollapse(e){this.dispatchEvent(new fi);let t=ot(getComputedStyle(this.childrenContainer).getPropertyValue("--hide-duration"));await tt(this.childrenContainer,[{height:`${this.childrenContainer.scrollHeight}px`,opacity:"1",overflow:"hidden"},{height:"0",opacity:"0",overflow:"hidden"}],{duration:t,easing:"cubic-bezier(0.4, 0.0, 0.2, 1)"}),this.animationGeneration===e&&(this.childrenContainer.hidden=!0,this.dispatchEvent(new ui))}isNestedItem(){let e=this.parentElement;return!!e&&k.isTreeItem(e)}updateIndentation(){let e=0,t=this.parentElement;for(;t;)k.isTreeItem(t)&&e++,t=t.parentElement;this.style.setProperty("--indent",`calc(${e} * var(--indent-size, 2em))`)}handleChildrenSlotChange(){this.loading=!1,this.isLeaf=!this.lazy&&this.getChildrenItems().length===0}willUpdate(e){e.has("selected")&&!e.has("indeterminate")&&(this.indeterminate=!1)}async animateExpand(e){this.dispatchEvent(new di),this.childrenContainer.hidden=!1;let t=ot(getComputedStyle(this.childrenContainer).getPropertyValue("--show-duration"));await tt(this.childrenContainer,[{height:"0",opacity:"0",overflow:"hidden"},{height:`${this.childrenContainer.scrollHeight}px`,opacity:"1",overflow:"hidden"}],{duration:t,easing:"cubic-bezier(0.4, 0.0, 0.2, 1)"}),this.animationGeneration===e&&(this.childrenContainer.style.height="auto",this.dispatchEvent(new pi))}handleLoadingChange(){this.setAttribute("aria-busy",this.loading?"true":"false"),this.loading||this.animateExpand(this.animationGeneration)}handleDisabledChange(){this.customStates.set("disabled",this.disabled),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleExpandedState(){this.customStates.set("expanded",this.expanded)}handleIndeterminateStateChange(){this.customStates.set("indeterminate",this.indeterminate)}handleSelectedChange(){this.customStates.set("selected",this.selected),this.setAttribute("aria-selected",this.selected?"true":"false")}handleExpandedChange(){this.isLeaf?this.removeAttribute("aria-expanded"):this.setAttribute("aria-expanded",this.expanded?"true":"false")}handleExpandAnimation(){this.animationGeneration++;let e=this.animationGeneration;this.expanded?this.lazy?(this.loading=!0,this.dispatchEvent(new li)):this.animateExpand(e):this.animateCollapse(e)}handleLazyChange(){this.dispatchEvent(new ni)}getChildrenItems({includeDisabled:e=!0}={}){return this.childrenSlot?[...this.childrenSlot.assignedElements({flatten:!0})].filter(t=>k.isTreeItem(t)&&(e||!t.disabled)):[]}render(){let e=this.localize.dir()==="rtl",t=!this.loading&&(!this.isLeaf||this.lazy);return T`
      <div
        part="base"
        class="${ie({"tree-item":!0,"tree-item-expanded":this.expanded,"tree-item-selected":this.selected,"tree-item-leaf":this.isLeaf,"tree-item-loading":this.loading,"tree-item-has-expand-button":t})}"
      >
        <div class="item" part="item">
          ...
          <div
            part="expand-button"
            class=${ie({"expand-button":!0,"expand-button-visible":t})}
            aria-hidden="true"
          >
    ...
    `}};me.css=ii;f([P("slot:not([name])")],me.prototype,"defaultSlot",2);f([P("slot[name=expand-icon]")],me.prototype,"expandedIconSlot",2);f([P("slot[name=collapse-icon]")],me.prototype,"collapsedIconSlot",2);f([c()],me.prototype,"selection",2);f([D("selection")],me.prototype,"handleSelectionChange",1);me=f([U("wa-tree")],me);var hi=(e={})=>{let{validationElement:t,validationProperty:o}=e;t||(t=Object.assign(document.createElement("input"),{required:!0})),o||(o="value");let r={observedAttributes:["required"],message:t.validationMessage,checkValidity(a){let s={message:"",isValid:!0,invalidKeys:[]};return(a.required??a.hasAttribute("required"))&&!a[o]&&(s.message=typeof r.message=="function"?r.message(a):r.message||"",s.isValid=!1,s.invalidKeys.push("valueMissing")),s}};return r};var xi=R`
  :host {
    display: flex;
    flex-direction: column;
  }
...
`;var pr=class extends H{constructor(){super(...arguments),this.localize=new ge(this)}render(){return T`
      <svg
        part="base"
        role="progressbar"
    ...
    `}};pr.css=vi;pr=f([U("wa-spinner")],pr);var Sl={"expand-icon":"chevron-right","collapse-icon":"chevron-right"};function wi(e){e.preventDefault()}function Al(e){e.stopImmediatePropagation()}var cr=class extends me{handleClick(t){let o=t.target,r=o.closest("jsdoc-tree-item"),a=t.composedPath().some(s=>s?.classList?.contains("expand-button"));!r||r.disabled||o!==this.clickTarget||(a?r.expanded=!r.expanded:this.selectItem(r))}},mr=class extends k{connectedCallback(){super.connectedCallback(),Object.entries(Sl).forEach(([t,o])=>{let r=Ka([t,o]);this.prepend(r)}),ao()}firstUpdated(){super.firstUpdated();for(let t of this.shadowRoot.querySelectorAll("wa-icon"))t.remove()}};customElements.define("jsdoc-tree",cr);customElements.define("jsdoc-tree-item",mr);document.querySelectorAll("wa-details").forEach(e=>{e.addEventListener("wa-hide",wi),e.addEventListener("wa-show",wi)});document.querySelectorAll(":not(wa-details) > jsdoc-tree > jsdoc-tree-item").forEach(e=>{let t=e.firstElementChild;t?.localName==="a"&&t.addEventListener("click",Al)});})();
...
@awesome.me/webawesome/dist/chunks/chunk.KEBNVAWE.js:
...
@awesome.me/webawesome/dist/chunks/chunk.67UEJGCD.js:
...
@awesome.me/webawesome/dist/chunks/chunk.KQRSJZW6.js:
...
@awesome.me/webawesome/dist/chunks/chunk.GAK65I6V.js:
@awesome.me/webawesome/dist/chunks/chunk.U4BL535G.js:
...
@awesome.me/webawesome/dist/chunks/chunk.RV7TPDPP.js:
